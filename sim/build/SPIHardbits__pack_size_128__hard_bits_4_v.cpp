//========================================================================
// VSPIHardbits__pack_size_128__hard_bits_4_v.cpp
//========================================================================
...
#include "obj_dir_SPIHardbits__pack_size_128__hard_bits_4/VSPIHardbits__pack_size_128__hard_bits_4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIHardbits__pack_size_128__hard_bits_4/VSPIHardbits__pack_size_128__hard_bits_4__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VSPIHardbits__pack_size_128__hard_bits_4_t *, char * );
  #endif
...
VSPIHardbits__pack_size_128__hard_bits_4_t * create_model( const char *vcd_filename ) {

  VSPIHardbits__pack_size_128__hard_bits_4_t * m;
  VSPIHardbits__pack_size_128__hard_bits_4   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIHardbits__pack_size_128__hard_bits_4_t *) malloc( sizeof(VSPIHardbits__pack_size_128__hard_bits_4_t) );
  model = new VSPIHardbits__pack_size_128__hard_bits_4();
  ...
  m->clk = &model->clk;
  m->detected_bits = &model->detected_bits;
  m->from_device = model->from_device;
  m->from_master = model->from_master;
  m->hard_msg = &model->hard_msg;
  m->reset = &model->reset;
  m->serve = &model->serve;
  m->to_device = model->to_device;
  m->to_master = model->to_master;
...
void destroy_model( VSPIHardbits__pack_size_128__hard_bits_4_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIHardbits__pack_size_128__hard_bits_4 * model = (VSPIHardbits__pack_size_128__hard_bits_4 *) m->model;
...
void comb_eval( VSPIHardbits__pack_size_128__hard_bits_4_t * m ) {
...
void seq_eval( VSPIHardbits__pack_size_128__hard_bits_4_t * m ) {
...
#if VLINETRACE
void trace( VSPIHardbits__pack_size_128__hard_bits_4_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIHardbits___05Fpack_size_128___05Fhard_bits_4__v );
