//========================================================================
// VSPILoopback__pack_size_128_v.cpp
//========================================================================
...
#include "obj_dir_SPILoopback__pack_size_128/VSPILoopback__pack_size_128.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPILoopback__pack_size_128/VSPILoopback__pack_size_128__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VSPILoopback__pack_size_128_t;

  // Exposed methods
  VSPILoopback__pack_size_128_t * create_model( const char * );
  void destroy_model( VSPILoopback__pack_size_128_t *);
  void comb_eval( VSPILoopback__pack_size_128_t * );
  void seq_eval( VSPILoopback__pack_size_128_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VSPILoopback__pack_size_128_t *, char * );
  #endif
...
VSPILoopback__pack_size_128_t * create_model( const char *vcd_filename ) {

  VSPILoopback__pack_size_128_t * m;
  VSPILoopback__pack_size_128   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPILoopback__pack_size_128_t *) malloc( sizeof(VSPILoopback__pack_size_128_t) );
  model = new VSPILoopback__pack_size_128();
...
void destroy_model( VSPILoopback__pack_size_128_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPILoopback__pack_size_128 * model = (VSPILoopback__pack_size_128 *) m->model;
...
void comb_eval( VSPILoopback__pack_size_128_t * m ) {
...
void seq_eval( VSPILoopback__pack_size_128_t * m ) {
...
#if VLINETRACE
void trace( VSPILoopback__pack_size_128_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPILoopback___05Fpack_size_128__v );
