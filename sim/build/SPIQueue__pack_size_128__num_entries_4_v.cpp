//========================================================================
// VSPIQueue__pack_size_128__num_entries_4_v.cpp
//========================================================================
...
#include "obj_dir_SPIQueue__pack_size_128__num_entries_4/VSPIQueue__pack_size_128__num_entries_4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIQueue__pack_size_128__num_entries_4/VSPIQueue__pack_size_128__num_entries_4__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VSPIQueue__pack_size_128__num_entries_4_t *, char * );
  #endif
...
VSPIQueue__pack_size_128__num_entries_4_t * create_model( const char *vcd_filename ) {

  VSPIQueue__pack_size_128__num_entries_4_t * m;
  VSPIQueue__pack_size_128__num_entries_4   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIQueue__pack_size_128__num_entries_4_t *) malloc( sizeof(VSPIQueue__pack_size_128__num_entries_4_t) );
  model = new VSPIQueue__pack_size_128__num_entries_4();
...
void destroy_model( VSPIQueue__pack_size_128__num_entries_4_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIQueue__pack_size_128__num_entries_4 * model = (VSPIQueue__pack_size_128__num_entries_4 *) m->model;
...
void comb_eval( VSPIQueue__pack_size_128__num_entries_4_t * m ) {
...
void seq_eval( VSPIQueue__pack_size_128__num_entries_4_t * m ) {
...
#if VLINETRACE
void trace( VSPIQueue__pack_size_128__num_entries_4_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIQueue___05Fpack_size_128___05Fnum_entries_4__v );
