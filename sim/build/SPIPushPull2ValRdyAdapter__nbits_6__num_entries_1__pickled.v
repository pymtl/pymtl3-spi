//-------------------------------------------------------------------------
// SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1.v
//-------------------------------------------------------------------------
...
module NormalQueue1EntryRTL__EntryType_4
(
  input  logic [0:0] clk ,
  ...
  output logic [3:0] deq__ret  ,
  input logic [0:0] enq__en  ,
  input logic [3:0] enq__msg  ,
...
module NormalQueueRTL__EntryType_4__num_entries_1
(
  input  logic [0:0] clk ,
  output logic [0:0] count ,
  input  logic [0:0] reset ,
  ...
  logic [3:0] q__deq__ret;
  logic [0:0] q__enq__en;
  logic [3:0] q__enq__msg;
  logic [0:0] q__enq__rdy;

  NormalQueue1EntryRTL__EntryType_4 q
  (
    .clk( q__clk ),
    .count( q__count ),
    .reset( q__reset ),
...
module SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input logic [0:0] pull__en  ,
  input MosiMsg__val_wrt_1__val_rd_1__data_4 pull__msg  ,
  input logic [0:0] push__en  ,
  output MisoMsg__val_1__spc_1__data_4 push__msg  ,
  ...
  logic [3:0] cm_q__deq__ret;
  logic [0:0] cm_q__enq__en;
  logic [3:0] cm_q__enq__msg;
  logic [0:0] cm_q__enq__rdy;

  NormalQueueRTL__EntryType_4__num_entries_1 cm_q
  (
    .clk( cm_q__clk ),
    .count( cm_q__count ),
    .reset( cm_q__reset ),
  ...
  logic [3:0] mc_q__deq__ret;
  logic [0:0] mc_q__enq__en;
  logic [3:0] mc_q__enq__msg;
  logic [0:0] mc_q__enq__rdy;

  NormalQueueRTL__EntryType_4__num_entries_1 mc_q
  (
    .clk( mc_q__clk ),
    .count( mc_q__count ),
    .reset( mc_q__reset ),
