...
#=========================================================================
# VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPIPushPull2ValRdyAdapter__nbits_4__num_entries_1
#-------------------------------------------------------------------------

class SPIPushPull2ValRdyAdapter__nbits_4__num_entries_1( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_t;

      VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_t * create_model( const char * );
      void destroy_model( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_t *);
      void comb_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_t * );
      void seq_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_t * );
    ...
    #   'libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_v.so', os.path.getmtime( './libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_1_v.so')

    # increment instance count
    SPIPushPull2ValRdyAdapter__nbits_4__num_entries_1.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "SPIPushPull2ValRdyAdapter__nbits_4__num_entries_1.verilator1.vcd"
