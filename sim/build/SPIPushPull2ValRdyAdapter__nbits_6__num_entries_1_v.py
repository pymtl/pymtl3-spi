...
#=========================================================================
# VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1
#-------------------------------------------------------------------------

class SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t;

      VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * create_model( const char * );
      void destroy_model( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t *);
      void comb_eval( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * );
      void seq_eval( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * );
    ...
    #   'libSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_v.so', os.path.getmtime( './libSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_v.so')

    # increment instance count
    SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1.verilator1.vcd"
    ...
    s.pull = PushInIfc( MosiMsg__val_wrt_1__val_rd_1__data_4 )
    s.push = PullOutIfc( MisoMsg__val_1__spc_1__data_4 )
    s.recv = RecvIfcRTL( 4 )
    s.send = SendIfcRTL( 4 )
    ...
    s.s_DOT_pull_DOT_msg = Wire( Bits6 )
    @update
    def istruct_s_DOT_pull_DOT_msg():
      s.s_DOT_pull_DOT_msg @= s.pull.msg
    ...
    s.s_DOT_recv_DOT_en = Wire( Bits1 )
    @update
    def isignal_s_DOT_recv_DOT_en():
      s.s_DOT_recv_DOT_en @= s.recv.en
    
    s.s_DOT_recv_DOT_msg = Wire( Bits4 )
    @update
    ...
    s.s_DOT_push_DOT_msg = Wire( Bits6 )
    @update
    def ostruct_s_DOT_push_DOT_msg():
      s.push.msg.data @= s.s_DOT_push_DOT_msg[0:4]
      s.push.msg.spc @= s.s_DOT_push_DOT_msg[4:5]
      s.push.msg.val @= s.s_DOT_push_DOT_msg[5:6]
    ...
    s.s_DOT_send_DOT_en = Wire( Bits1 )
    @update
    def osignal_s_DOT_send_DOT_en():
      s.send.en @= s.s_DOT_send_DOT_en
    
    s.s_DOT_send_DOT_msg = Wire( Bits4 )
    @update
    ...
    def comb_upblk():
      ...
      _ffi_m.pull___05Fmsg[0] = int(s.s_DOT_pull_DOT_msg)
      
      _ffi_m.push___05Fen[0] = int(s.s_DOT_push_DOT_en)
      
      _ffi_m.recv___05Fen[0] = int(s.s_DOT_recv_DOT_en)
      ...
      s.s_DOT_push_DOT_msg @= _ffi_m.push___05Fmsg[0]
      
      s.s_DOT_recv_DOT_rdy @= _ffi_m.recv___05Frdy[0]
      
      s.s_DOT_send_DOT_en @= _ffi_m.send___05Fen[0]
  ...
  def line_trace( s ):
    if 0:
      ...
      return f' clk={s.clk}, reset={s.reset}, pull.en={s.pull.en}, pull.msg={s.pull.msg}, push.en={s.push.en}, push.msg={s.push.msg}, recv.en={s.recv.en}, recv.msg={s.recv.msg}, recv.rdy={s.recv.rdy}, send.en={s.send.en}, send.msg={s.send.msg}, send.rdy={s.send.rdy},'
