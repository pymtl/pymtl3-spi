//========================================================================
// VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_v.cpp
//========================================================================
...
#include "obj_dir_SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1/VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIPushPull2ValRdyAdapter__nbits_6__num_entries_1/VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t *, char * );
  #endif
...
VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * create_model( const char *vcd_filename ) {

  VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * m;
  VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t *) malloc( sizeof(VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t) );
  model = new VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1();
...
void destroy_model( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1 * model = (VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1 *) m->model;
...
void comb_eval( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * m ) {
...
void seq_eval( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * m ) {
...
#if VLINETRACE
void trace( VSPIPushPull2ValRdyAdapter__nbits_6__num_entries_1_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIPushPull2ValRdyAdapter___05Fnbits_6___05Fnum_entries_1__v );
