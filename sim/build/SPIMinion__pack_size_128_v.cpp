//========================================================================
// VSPIMinion__pack_size_128_v.cpp
//========================================================================
...
#include "obj_dir_SPIMinion__pack_size_128/VSPIMinion__pack_size_128.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIMinion__pack_size_128/VSPIMinion__pack_size_128__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VSPIMinion__pack_size_128_t *, char * );
  #endif
...
VSPIMinion__pack_size_128_t * create_model( const char *vcd_filename ) {

  VSPIMinion__pack_size_128_t * m;
  VSPIMinion__pack_size_128   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIMinion__pack_size_128_t *) malloc( sizeof(VSPIMinion__pack_size_128_t) );
  model = new VSPIMinion__pack_size_128();
...
void destroy_model( VSPIMinion__pack_size_128_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIMinion__pack_size_128 * model = (VSPIMinion__pack_size_128 *) m->model;
...
void comb_eval( VSPIMinion__pack_size_128_t * m ) {
...
void seq_eval( VSPIMinion__pack_size_128_t * m ) {
...
#if VLINETRACE
void trace( VSPIMinion__pack_size_128_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIMinion___05Fpack_size_128__v );
