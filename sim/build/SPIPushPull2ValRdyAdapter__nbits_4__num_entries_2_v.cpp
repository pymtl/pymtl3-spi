//========================================================================
// VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_v.cpp
//========================================================================
...
#include "obj_dir_SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2/VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2/VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t *, char * );
  #endif
...
VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * create_model( const char *vcd_filename ) {

  VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * m;
  VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t *) malloc( sizeof(VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t) );
  model = new VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2();
...
void destroy_model( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2 * model = (VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2 *) m->model;
...
void comb_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * m ) {
...
void seq_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * m ) {
...
#if VLINETRACE
void trace( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIPushPull2ValRdyAdapter___05Fnbits_4___05Fnum_entries_2__v );
