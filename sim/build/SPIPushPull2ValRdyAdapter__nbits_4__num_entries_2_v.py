...
#=========================================================================
# VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2
#-------------------------------------------------------------------------

class SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t;

      VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * create_model( const char * );
      void destroy_model( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t *);
      void comb_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * );
      void seq_eval( VSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_t * );
    ...
    #   'libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_v.so', os.path.getmtime( './libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPIPushPull2ValRdyAdapter__nbits_4__num_entries_2_v.so')

    # increment instance count
    SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "SPIPushPull2ValRdyAdapter__nbits_4__num_entries_2.verilator1.vcd"
    ...
    s.pull = PushInIfc( MosiMsg__val_wrt_1__val_rd_1__data_2 )
    s.push = PullOutIfc( MisoMsg__val_1__spc_1__data_2 )
    s.recv = RecvIfcRTL( 2 )
    s.send = SendIfcRTL( 2 )
    ...
    def ostruct_s_DOT_push_DOT_msg():
      s.push.msg.data @= s.s_DOT_push_DOT_msg[0:2]
      s.push.msg.spc @= s.s_DOT_push_DOT_msg[2:3]
      s.push.msg.val @= s.s_DOT_push_DOT_msg[3:4]
