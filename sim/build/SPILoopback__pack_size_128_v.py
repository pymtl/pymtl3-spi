...
#=========================================================================
# VSPILoopback__pack_size_128_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPILoopback__pack_size_128
#-------------------------------------------------------------------------

class SPILoopback__pack_size_128( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libSPILoopback__pack_size_128_v.so', os.path.getmtime( './libSPILoopback__pack_size_128_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPILoopback__pack_size_128_v.so')

    # increment instance count
    SPILoopback__pack_size_128.id_ += 1
  ...
  def line_trace( s ):
    if 0:
      ...
      return f' clk={s.clk}, from_device={s.from_device}, from_master={s.from_master}, loop_en={s.loop_en}, serve={s.serve}, to_device={s.to_device}, to_master={s.to_master},'
