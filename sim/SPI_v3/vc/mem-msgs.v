...
typedef struct packed {
  logic [3:0]  type_;
  logic [11:0]  opaque;
  logic [11:0] addr;  // 12 bits for 4096 words in SRAM
  logic [1:0]  len;
  logic [31:0] data;
} mem_req_mystruct_t;
...
module vc_MemReqMsgSRAM16kBTrace
(
  input logic         clk,
  input logic         reset,
  input logic         val,
  input logic         rdy,
  input mem_req_mystruct_t  msg
);
  ...
  localparam c_msg_nbits = $bits(mem_req_mystruct_t);
...
module vc_MemRespMsgSRAM16kBTrace
(
  input logic          clk,
  input logic          reset,
  input logic          val,
  input logic          rdy,
  input mem_resp_mystruct_t  msg
);
  ...
  localparam c_msg_nbits  = $bits(mem_resp_mystruct_t);
