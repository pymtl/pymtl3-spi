...
def test_basic( cmdline_opts ):
  ...
  t( dut,  1,       0,         0,         '?',       0,         1,             0,      0x3,         0,        1,      0x0,       1,         0,      '?') #MOSI msg
  ...
  t( dut,  0,       0,         1,         '?',       1,         0,             1,      0x0,         0,        0,      0x0,       0,         1,      '?') #accept MISO msg push
  t( dut,  1,       1,         1,         0x3,       0,         0,             1,      0x0,         0,        0,      0x0,       0,         1,      '?') #accept MISO msg pull
                                                                                                                                                               
  t( dut,  0,       0,         1,         '?',       0,         0,             0,      0x0,         0,        1,      0x0,       0,         1,      '?') #empty
  t( dut,  0,       0,         0,         '?',       1,         1,             0,      0x2,         1,        1,      0x1,       0,         1,      '?') #write both queues push
  t( dut,  1,       0,         0,         '?',       0,         1,             0,      0x2,         1,        0,      0x1,       1,         0,      '?') #write both queues pull
  t( dut,  0,       0,         0,         '?',       1,         0,             1,      0x0,         0,        0,      0x0,       1,         1,      0x2) #read both queues push
  t( dut,  1,       1,         1,         0x1,       0,         0,             1,      0x0,         0,        0,      0x0,       0,         1,      '?') #read both queues push

  t( dut,  0,       0,         1,         '?',       0,         0,             0,      0x0,         0,        1,      0x0,       0,         1,      '?') #empty
  t( dut,  0,       0,         0,         '?',       1,         1,             0,      0x2,         1,        1,      0x1,       0,         1,      '?') #write both queues push
  t( dut,  1,       0,         0,         '?',       0,         1,             0,      0x2,         1,        0,      0x1,       1,         0,      '?') #write both queues pull
  t( dut,  0,       0,         0,         '?',       1,         0,             1,      0x0,         0,        0,      0x0,       1,         0,      '?') #read both queues push
  t( dut,  1,       1,         0,         0x1,       0,         0,             1,      0x0,         0,        0,      0x0,       1,         1,      0x2) #read both queues push

  t( dut,  0,       0,         1,         '?',       0,         0,             0,      0x0,         0,        1,      0x0,       0,         1,      '?') #empty
  t( dut,  0,       0,         1,         '?',       1,         0,             1,      0x0,         0,        1,      0x0,       0,         1,      '?') #read both queues push
  t( dut,  1,       0,         1,         '?',       0,         0,             1,      0x0,         0,        1,      0x0,       0,         1,      '?') #read both queues push

  t( dut,  0,       0,         1,         '?',       0,         0,             0,      0x0,         0,        1,      0x0,       0,         1,      '?') #empty
  t( dut,  0,       0,         0,         '?',       1,         1,             0,      0x2,         0,        1,      0x1,       0,         1,      '?') #write mosi push
  t( dut,  1,       0,         0,         '?',       0,         1,             0,      0x2,         0,        1,      0x1,       1,         1,      0x2) #write mosi pull
  t( dut,  0,       0,         1,         '?',       1,         0,             1,      0x0,         0,        1,      0x0,       0,         1,      '?') #read miso push
  t( dut,  1,       0,         1,         '?',       0,         0,             1,      0x0,         0,        1,      0x0,       0,         1,      '?') #read miso push
...
def test_queue_len2( cmdline_opts ):
  ...
  #     pull_en, pull_val, pull_spc, pull_data, push_en, push_val_wrt, push_val_rd, push_data, recv_val, recv_rdy, recv_msg, send_val, send_rdy, send_msg 
  t( dut,  0,        0,        1,       '?',       0,         0,            0,         0x0,         0,        1,      0x0,       0,         0,      '?') #init
  t( dut,  0,        0,        1,       '?',       1,         1,            0,         0x3,         0,        1,      0x0,       0,         0,      '?') #MOSI msg push
  t( dut,  1,        0,        1,       '?',       0,         1,            0,         0x3,         0,        1,      0x0,       1,         0,      '?') #MOSI msg pull
  t( dut,  0,        0,        1,       '?',       0,         1,            0,         0x0,         0,        1,      0x0,       1,         1,      0x3) #send msg
  
  t( dut,  0,        0,        1,       '?',       0,         1,            0,         0x0,         1,        1,      0x3,       0,         1,      '?') #recv msg
  t( dut,  0,        0,        1,       '?',       1,         0,            1,         0x0,         0,        1,      0x0,       0,         1,      '?') #accept MISO msg push
  t( dut,  1,        1,        1,       0x3,       0,         0,            1,         0x0,         0,        1,      0x0,       0,         1,      '?') #accept MISO msg pull
  
  t( dut,  0,        0,        1,       '?',       1,         1,            0,         0x2,         1,        1,      0x1,       0,         1,      '?') #write both queues push
  t( dut,  1,        0,        1,       '?',       0,         1,            0,         0x2,         0,        1,      0x1,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        1,       0x1,       1,         0,            1,         0x0,         0,        1,      0x0,       1,         1,      0x2) #read both queues push
  t( dut,  1,        1,        1,       0x1,       0,         0,            1,         0x0,         0,        1,      0x0,       0,         1,      '?') #read both queues pull
  
  t( dut,  0,        0,        1,       '?',       1,         1,            0,         0x1,         0,        1,      0x2,       0,         0,      '?') #write mosi push
  t( dut,  1,        0,        1,       '?',       0,         1,            0,         0x1,         1,        1,      0x2,       1,         0,      '?') #write miso pull
  t( dut,  0,        0,        0,       '?',       1,         1,            0,         0x2,         1,        1,      0x1,       1,         0,      '?') #write both queues push
  t( dut,  1,        0,        0,       '?',       0,         1,            0,         0x2,         0,        0,      0x1,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        0,       '?',       1,         0,            1,         0x0,         0,        0,      0x0,       1,         1,      0x1) #read both queues push
  t( dut,  1,        1,        1,       0x2,       0,         0,            1,         0x0,         0,        0,      0x0,       1,         1,      0x2) #read both queues pull
  t( dut,  0,        0,        1,       '?',       1,         0,            1,         0x0,         0,        1,      0x0,       0,         1,      '?') #read miso queues push
  t( dut,  1,        1,        1,       0x1,       0,         0,            1,         0x0,         0,        1,      0x0,       0,         1,      '?') #read miso queues pull

  t( dut,  0,        0,        1,       '?',       1,         1,            0,         0x1,         1,        1,      0x1,       0,         0,      '?') #write both queues push
  t( dut,  1,        0,        1,       '?',       0,         1,            0,         0x1,         1,        1,      0x2,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        0,       '?',       1,         1,            0,         0x2,         1,        0,      0x0,       1,         0,      '?') #write both queues push
  t( dut,  1,        0,        0,       '?',       0,         1,            0,         0x2,         1,        0,      0x0,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        0,       '?',       1,         0,            1,         0x0,         0,        0,      0x0,       1,         1,      0x1) #read both queues push
  t( dut,  1,        1,        1,       0x1,       0,         0,            1,         0x0,         0,        0,      0x0,       1,         0,      '?') #read both queues pull
  t( dut,  0,        0,        0,       '?',       1,         1,            0,         0x3,         0,        1,      0x3,       1,         0,      '?') #write both queues push
  t( dut,  1,        0,        0,       '?',       1,         1,            0,         0x3,         1,        1,      0x3,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        0,       '?',       1,         0,            1,         0x0,         0,        0,      0x0,       1,         1,      0x2) #read both queues push
  t( dut,  1,        1,        1,       0x2,       0,         0,            1,         0x0,         0,        0,      0x0,       1,         0,      '?') #read both queues pull
  t( dut,  0,        0,        1,       '?',       1,         0,            1,         0x0,         0,        1,      0x0,       1,         0,      '?') #read both queues push
...
def test_more_bits( cmdline_opts ):
  ...
  #       pull_en, pull_val, pull_spc, pull_data, push_en, push_val_wrt, push_val_rd, push_data, recv_val, recv_rdy, recv_msg, send_val, send_rdy, send_msg 
  t( dut,  0,        0,        1,       '?',       0,         0,            0,         0x0,         0,        1,      0x0,       0,         0,      '?') #init
  t( dut,  0,        0,        0,       '?',       1,         1,            0,         0xF,         1,        1,      0xE,       0,         0,      '?') #write both queues push
  t( dut,  1,        0,        0,       '?',       0,         1,            0,         0xF,         1,        0,      0xE,       1,         0,      '?') #write both queues pull
  t( dut,  0,        0,        0,       '?',       1,         0,            1,         0x0,         0,        0,      0x0,       1,         1,      0xF) #read both queues push
