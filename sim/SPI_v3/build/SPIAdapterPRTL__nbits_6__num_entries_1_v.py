...
#=========================================================================
# VSPIAdapterPRTL__nbits_6__num_entries_1_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPIAdapterPRTL__nbits_6__num_entries_1
#-------------------------------------------------------------------------

class SPIAdapterPRTL__nbits_6__num_entries_1( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libSPIAdapterPRTL__nbits_6__num_entries_1_v.so', os.path.getmtime( './libSPIAdapterPRTL__nbits_6__num_entries_1_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPIAdapterPRTL__nbits_6__num_entries_1_v.so')

    # increment instance count
    SPIAdapterPRTL__nbits_6__num_entries_1.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "SPIAdapterPRTL__nbits_6__num_entries_1.verilator1.vcd"
    ...
    s.pull = PullOutIfc( MisoMsg__val_1__spc_1__data_4 )
    s.push = PushInIfc( MosiMsg__val_wrt_1__val_rd_1__data_4 )
    s.recv = RecvIfcRTL( Bits4 )
    s.send = SendIfcRTL( Bits4 )
    ...
    def ostruct_s_DOT_pull_DOT_msg():
      s.pull.msg.data @= s.s_DOT_pull_DOT_msg[0:4]
      s.pull.msg.spc @= s.s_DOT_pull_DOT_msg[4:5]
      s.pull.msg.val @= s.s_DOT_pull_DOT_msg[5:6]
