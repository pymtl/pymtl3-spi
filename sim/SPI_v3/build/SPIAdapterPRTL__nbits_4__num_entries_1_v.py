...
#=========================================================================
# VSPIAdapterPRTL__nbits_4__num_entries_1_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# SPIAdapterPRTL__nbits_4__num_entries_1
#-------------------------------------------------------------------------

class SPIAdapterPRTL__nbits_4__num_entries_1( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libSPIAdapterPRTL__nbits_4__num_entries_1_v.so', os.path.getmtime( './libSPIAdapterPRTL__nbits_4__num_entries_1_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libSPIAdapterPRTL__nbits_4__num_entries_1_v.so')

    # increment instance count
    SPIAdapterPRTL__nbits_4__num_entries_1.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "SPIAdapterPRTL__nbits_4__num_entries_1.verilator1.vcd"
