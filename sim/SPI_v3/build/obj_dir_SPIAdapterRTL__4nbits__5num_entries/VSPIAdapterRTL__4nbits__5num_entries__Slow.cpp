...
VL_CTOR_IMP(VSPIAdapterRTL__4nbits__5num_entries) {
    VSPIAdapterRTL__4nbits__5num_entries__Syms* __restrict vlSymsp = __VlSymsp = new VSPIAdapterRTL__4nbits__5num_entries__Syms(this, name());
...
void VSPIAdapterRTL__4nbits__5num_entries::__Vconfigure(VSPIAdapterRTL__4nbits__5num_entries__Syms* vlSymsp, bool first) {
...
VSPIAdapterRTL__4nbits__5num_entries::~VSPIAdapterRTL__4nbits__5num_entries() {
    VL_DO_CLEAR(delete __VlSymsp, __VlSymsp = NULL);
}

void VSPIAdapterRTL__4nbits__5num_entries::_settle__TOP__1(VSPIAdapterRTL__4nbits__5num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__5num_entries::_settle__TOP__1\n"); );
    VSPIAdapterRTL__4nbits__5num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->send_msg = (3U & (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q_send_msg));
...
void VSPIAdapterRTL__4nbits__5num_entries::_eval_initial(VSPIAdapterRTL__4nbits__5num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__5num_entries::_eval_initial\n"); );
    VSPIAdapterRTL__4nbits__5num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->__Vclklast__TOP__clk = vlTOPp->clk;
}

void VSPIAdapterRTL__4nbits__5num_entries::final() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__5num_entries::final\n"); );
    // Variables
    VSPIAdapterRTL__4nbits__5num_entries__Syms* __restrict vlSymsp = this->__VlSymsp;
    VSPIAdapterRTL__4nbits__5num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void VSPIAdapterRTL__4nbits__5num_entries::_eval_settle(VSPIAdapterRTL__4nbits__5num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__5num_entries::_eval_settle\n"); );
    VSPIAdapterRTL__4nbits__5num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->_settle__TOP__1(vlSymsp);
}

void VSPIAdapterRTL__4nbits__5num_entries::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__5num_entries::_ctor_var_reset\n"); );
    // Body
    ...
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT____Vcellout__v__pull_msg_data = VL_RAND_RESET_I(4);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_send_rdy = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_q_recv_rdy = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_q_send_val = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT____Vcellout__cm_q__send_msg = VL_RAND_RESET_I(4);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT____Vcellout__cm_q__count = VL_RAND_RESET_I(3);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q_recv_rdy = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q_send_msg = VL_RAND_RESET_I(4);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q_send_val = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT____Vcellout__mc_q__count = VL_RAND_RESET_I(3);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__recv_xfer = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__send_xfer = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__recv_xfer = VL_RAND_RESET_I(1);
    SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__send_xfer = VL_RAND_RESET_I(1);
    __Vchglast__TOP__SPIAdapterRTL___05F4nbits___05F5num_entries__DOT__v__DOT__cm_q_send_val = VL_RAND_RESET_I(1);
}
