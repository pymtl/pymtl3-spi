//-------------------------------------------------------------------------
// SPIAdapterPRTL__nbits_6__num_entries_1.v
//-------------------------------------------------------------------------
// This file is generated by PyMTL SystemVerilog translation pass.

// PyMTL BitStruct MisoMsg__val_1__spc_1__data_4 Definition
typedef struct packed {
  logic [0:0] val;
  logic [0:0] spc;
  logic [3:0] data;
} MisoMsg__val_1__spc_1__data_4;

// PyMTL BitStruct MosiMsg__val_wrt_1__val_rd_1__data_4 Definition
typedef struct packed {
  logic [0:0] val_wrt;
  logic [0:0] val_rd;
  logic [3:0] data;
} MosiMsg__val_wrt_1__val_rd_1__data_4;
...
module NormalQueue1EntryRTL__EntryType_Bits4
(
  input  logic [0:0] clk ,
  output logic [0:0] count ,
  input  logic [0:0] reset ,
  input logic [3:0] recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output logic [3:0] send__msg  ,
...
module NormalQueueRTL__EntryType_Bits4__num_entries_1
(
  input  logic [0:0] clk ,
  output logic [0:0] count ,
  input  logic [0:0] reset ,
...
module SPIAdapterPRTL__nbits_6__num_entries_1
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  input logic [0:0] pull__en  ,
  output MisoMsg__val_1__spc_1__data_4 pull__msg  ,
  input logic [0:0] push__en  ,
  input MosiMsg__val_wrt_1__val_rd_1__data_4 push__msg  ,
  input logic [3:0] recv__msg  ,
  output logic [0:0] recv__rdy  ,
  input logic [0:0] recv__val  ,
  output logic [3:0] send__msg  ,
  ...
  logic [3:0] cm_q__recv__msg;
  logic [0:0] cm_q__recv__rdy;
  logic [0:0] cm_q__recv__val;
  logic [3:0] cm_q__send__msg;
  logic [0:0] cm_q__send__rdy;
  logic [0:0] cm_q__send__val;

  NormalQueueRTL__EntryType_Bits4__num_entries_1 cm_q
  (
    .clk( cm_q__clk ),
    .count( cm_q__count ),
    .reset( cm_q__reset ),
  ...
  logic [3:0] mc_q__recv__msg;
  logic [0:0] mc_q__recv__rdy;
  logic [0:0] mc_q__recv__val;
  logic [3:0] mc_q__send__msg;
  logic [0:0] mc_q__send__rdy;
  logic [0:0] mc_q__send__val;

  NormalQueueRTL__EntryType_Bits4__num_entries_1 mc_q
  (
    .clk( mc_q__clk ),
    .count( mc_q__count ),
    .reset( mc_q__reset ),
  ...
  always_comb begin : comb_block
    ...
    pull__msg.data = cm_q__send__msg & { { 3 { pull__msg.val[0] } }, pull__msg.val };
  end
