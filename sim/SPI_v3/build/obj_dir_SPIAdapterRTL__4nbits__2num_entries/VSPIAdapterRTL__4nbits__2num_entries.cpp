...
void VSPIAdapterRTL__4nbits__2num_entries::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate VSPIAdapterRTL__4nbits__2num_entries::eval\n"); );
    VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp = this->__VlSymsp;  // Setup global symbol table
...
void VSPIAdapterRTL__4nbits__2num_entries::_eval_initial_loop(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
...
VL_INLINE_OPT void VSPIAdapterRTL__4nbits__2num_entries::_combo__TOP__2(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_combo__TOP__2\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void VSPIAdapterRTL__4nbits__2num_entries::_sequent__TOP__3(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_sequent__TOP__3\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*2:0*/ __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count;
    CData/*2:0*/ __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count;
    // Body
    __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count 
        = vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count;
    __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count 
        = vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count;
    if (vlTOPp->reset) {
        __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count = 0U;
    } else {
        if (((IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__recv_xfer) 
             & (~ (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__send_xfer)))) {
            __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count 
                = (7U & ((IData)(1U) + (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count)));
        } else {
            if (((~ (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__recv_xfer)) 
                 & (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q__DOT__genblk2__DOT__send_xfer))) {
                __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count 
                    = (7U & ((IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__cm_q__count) 
                             - (IData)(1U)));
            }
        }
    }
    if (vlTOPp->reset) {
        __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count = 0U;
    } else {
        if (((IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__recv_xfer) 
             & (~ (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__send_xfer)))) {
            __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count 
                = (7U & ((IData)(1U) + (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count)));
        } else {
            if (((~ (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__recv_xfer)) 
                 & (IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__mc_q__DOT__genblk2__DOT__send_xfer))) {
                __Vdly__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count 
                    = (7U & ((IData)(vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT____Vcellout__mc_q__count) 
                             - (IData)(1U)));
            }
        }
    }
...
VL_INLINE_OPT void VSPIAdapterRTL__4nbits__2num_entries::_combo__TOP__4(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_combo__TOP__4\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VSPIAdapterRTL__4nbits__2num_entries::_eval(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_eval\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT QData VSPIAdapterRTL__4nbits__2num_entries::_change_request(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_change_request\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    return (vlTOPp->_change_request_1(vlSymsp));
}

VL_INLINE_OPT QData VSPIAdapterRTL__4nbits__2num_entries::_change_request_1(VSPIAdapterRTL__4nbits__2num_entries__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_change_request_1\n"); );
    VSPIAdapterRTL__4nbits__2num_entries* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
    QData __req = false;  // Logically a bool
    __req |= ((vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val ^ vlTOPp->__Vchglast__TOP__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val));
    VL_DEBUG_IF( if(__req && ((vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val ^ vlTOPp->__Vchglast__TOP__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val))) VL_DBG_MSGF("        CHANGE: SPI_v3/components/SPIAdapterVRTL.v:45: SPIAdapterRTL__4nbits__2num_entries.v.cm_q_send_val\n"); );
    // Final
    vlTOPp->__Vchglast__TOP__SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val 
        = vlTOPp->SPIAdapterRTL___05F4nbits___05F2num_entries__DOT__v__DOT__cm_q_send_val;
    return __req;
...
#ifdef VL_DEBUG
void VSPIAdapterRTL__4nbits__2num_entries::_eval_debug_assertions() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSPIAdapterRTL__4nbits__2num_entries::_eval_debug_assertions\n"); );
    // Body
