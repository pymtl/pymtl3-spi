//========================================================================
// VSPIAdapterPRTL__nbits_4__num_entries_5_v.cpp
//========================================================================
...
#include "obj_dir_SPIAdapterPRTL__nbits_4__num_entries_5/VSPIAdapterPRTL__nbits_4__num_entries_5.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SPIAdapterPRTL__nbits_4__num_entries_5/VSPIAdapterPRTL__nbits_4__num_entries_5__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VSPIAdapterPRTL__nbits_4__num_entries_5_t;

  // Exposed methods
  VSPIAdapterPRTL__nbits_4__num_entries_5_t * create_model( const char * );
  void destroy_model( VSPIAdapterPRTL__nbits_4__num_entries_5_t *);
  void comb_eval( VSPIAdapterPRTL__nbits_4__num_entries_5_t * );
  void seq_eval( VSPIAdapterPRTL__nbits_4__num_entries_5_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VSPIAdapterPRTL__nbits_4__num_entries_5_t *, char * );
  #endif
...
VSPIAdapterPRTL__nbits_4__num_entries_5_t * create_model( const char *vcd_filename ) {

  VSPIAdapterPRTL__nbits_4__num_entries_5_t * m;
  VSPIAdapterPRTL__nbits_4__num_entries_5   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VSPIAdapterPRTL__nbits_4__num_entries_5_t *) malloc( sizeof(VSPIAdapterPRTL__nbits_4__num_entries_5_t) );
  model = new VSPIAdapterPRTL__nbits_4__num_entries_5();
...
void destroy_model( VSPIAdapterPRTL__nbits_4__num_entries_5_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSPIAdapterPRTL__nbits_4__num_entries_5 * model = (VSPIAdapterPRTL__nbits_4__num_entries_5 *) m->model;
...
void comb_eval( VSPIAdapterPRTL__nbits_4__num_entries_5_t * m ) {
...
void seq_eval( VSPIAdapterPRTL__nbits_4__num_entries_5_t * m ) {
...
#if VLINETRACE
void trace( VSPIAdapterPRTL__nbits_4__num_entries_5_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_SPIAdapterPRTL___05Fnbits_4___05Fnum_entries_5__v );
