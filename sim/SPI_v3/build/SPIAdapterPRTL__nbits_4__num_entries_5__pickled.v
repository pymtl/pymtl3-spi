//-------------------------------------------------------------------------
// SPIAdapterPRTL__nbits_4__num_entries_5.v
//-------------------------------------------------------------------------
...
module SPIAdapterPRTL__nbits_4__num_entries_5
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  ...
  localparam logic [2:0] __const__num_entries_at_comb_block  = 3'd5;
  ...
  NormalQueueRTL__EntryType_Bits2__num_entries_5 cm_q
  (
    .clk( cm_q__clk ),
    .count( cm_q__count ),
    .reset( cm_q__reset ),
  ...
  NormalQueueRTL__EntryType_Bits2__num_entries_5 mc_q
  (
    .clk( mc_q__clk ),
    .count( mc_q__count ),
    .reset( mc_q__reset ),
  ...
  always_comb begin : comb_block
    open_entries = mc_q__count < ( 3'( __const__num_entries_at_comb_block ) - 3'd1 );
